...
class FactorApriltagProj_class : public testing::Test{
    public:
        ...
        void SetUp() override
        {
            ...
            meas1 << pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn1),
                     pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn2),
                     pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn3),
                     pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn4);

            // Measurement for second keyframe
            meas2 << pinholeProjCorner(K, p_c2_l, q_c2_l, l_corn1),
                     pinholeProjCorner(K, p_c2_l, q_c2_l, l_corn2),
                     pinholeProjCorner(K, p_c2_l, q_c2_l, l_corn3),
                     pinholeProjCorner(K, p_c2_l, q_c2_l, l_corn4);
...
TEST_F(FactorApriltagProj_class, problem_1KF)
{
    ...
    Vector8d proj_post;
    proj_post << pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn1),
                 pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn2),
                 pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn3),
                 pinholeProjCorner(K, p_c1_l, q_c1_l, l_corn4);
